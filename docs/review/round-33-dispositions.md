...
Hosted correction checkpoint: e012b07 preview passed six HTTP checks including restricted/no-grant members on the populated fixture and same-session removal. Coordinator with explicit grants: 150 valid responses, p95 1,018 ms, zero probe-owned tasks. See ../ops/staging-query-rollout.md. This narrows the populated permission-proof gap for these combinations; it does not close browser or all grant-variant acceptance. Tally remains 3 OWED / 0 FIXED.
