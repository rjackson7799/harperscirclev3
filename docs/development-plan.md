...
| 5 | Implement the approved Admin foundation | Earn isolated auth lifecycle proof before schema changes; implement the bounded authorization and audit contract. | Owner approved at most two migrations and no deployment after c4a561c. Session verification tested; isolated SQL trigger/lifecycle capability passed on the existing GitHub runner at 5119e57. Next: real GoTrue and concurrent revocation proof. See docs/review/slice-10-capability-checkpoint.md. Home gates are not waived. |
