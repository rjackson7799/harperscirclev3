...
| 5 | Implement the approved Admin foundation | Earn isolated auth lifecycle proof before schema changes; implement the bounded authorization and audit contract. | Owner approved at most two migrations and no deployment after c4a561c. Session verification tested; SQL capability passed at 5119e57; real MFA and concurrent revocation prototype passed 19 assertions at 4443b36. Next: failing database tests and the two approved migrations. See docs/review/slice-10-capability-checkpoint.md. Home gates are not waived. |
